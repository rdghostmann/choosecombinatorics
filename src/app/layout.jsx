      ...
      <body className={inter.className} cz-shortcut-listen="true" >
        <header className="mx-auto flex flex-col justify-between w-full py-2 px-5 mb-4 bg-slate-500 sticky top-0 left-0 z-10 shadow-sm">
          <nav className="w-full flex items-center justify-center border-black">
            ...
            <Link className="grid place-items-center m-3 w-fit px-2 py-1 rounded-lg border border-gray-500 focus:border-2 focus:border-gray-800 bg-gray-300" href="/randrum">
              🔀Randrum<span className="hidden">Randrum</span>
            </Link>
            <LogOutBtn />
          </nav>
