...
const Combinatorics = () => {
  ...
  const handleCalculate = () => {
    if (chooseN < 2 || chooseN > 7) {
      alert("Choose n must be between 2 and 7");
      return;
    }
      ...
      <section className="hidden md:block text-xs">
        <div className="overflow-x-scroll m-6">
          <div className="flex flex-row space-x-1 sm:flex">
            ...
            <div className="border w-9/12 h-fit">
            <div className="border max-w-fit flex flex-col items-center">
